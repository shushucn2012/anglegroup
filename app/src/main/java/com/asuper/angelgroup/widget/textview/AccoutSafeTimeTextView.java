package com.asuper.angelgroup.widget.textview;
 ...
 */
public class AccoutSafeTimeTextView extends TextView implements Runnable {
	...
	public AccoutSafeTimeTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mPaint = new Paint();
	...
	public AccoutSafeTimeTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	public AccoutSafeTimeTextView(Context context) {
		super(context);
	}
