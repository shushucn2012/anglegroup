...
public class RegexValidator {
     ...
     * 正则表达式：验证密码
     */
    public static final String REGEX_PASSWORD = "^[a-zA-Z0-9]{6,16}$";//"^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$";// "^[a-zA-Z0-9]{6,20}$";

    /**
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE = "^(13|14|15|17|18)[0-9]{8}[0-9]$";
